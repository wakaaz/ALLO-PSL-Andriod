...
class VideoPreviewTutorialActivity : BaseActivity(), View.OnClickListener,
    ...
    //list
    public var list: List<TutorialData>? = null
    ...
    private var adapter: VideoPreviewTutorialAdapter? = null
    ...
    private fun setAdapter() {
        ...
        adapter = VideoPreviewTutorialAdapter(this, Constants.TYPE_VIDEO, "", this)
    ...
    private fun getIntentData() {
        if (intent != null &&
            ...
            selectedModel =
                intent.getSerializableExtra(Constants.SELECTED_DICTIONARY_LIST_MODEL) as TutorialData
            ...
            /* Handler().postDelayed({
                ...
                TutorialData?.id = selectedId
                if (list != null && list!!.size != 0 && selectedModel != null && (selectedModel!! as TutorialData).id != null) {
                    val finalList = ListSorting.sortList(
                        (selectedModel!! as TutorialData).indexPosition,
                        list!!
                    )
                    ...
                    if (isNetworkAvailable) {
                        if (progress.visibility == View.GONE) {
                            if (networkType == Constants.NetworkTYPE_MOB_DATA) {
                                if (ReuseFunctions.networkQualityMobData(this@VideoPreviewTutorialActivity) ==
                                    SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)
                                        ?.getQualityMob()
                                ) {
                                    ...
                                    SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)
                                        ?.setQualityMob(ReuseFunctions.networkQualityMobData(this@VideoPreviewTutorialActivity))
                                    setUrlOfQuality(ReuseFunctions.networkQualityMobData(this@VideoPreviewTutorialActivity))

                                }
                            } else if (networkType == Constants.NetworkTYPE_WIFI) {
                                if (ReuseFunctions.networkQualityWifi(this@VideoPreviewTutorialActivity) ==
                                    SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)
                                        ?.getQualityWifi()
                                ) {
                                    //do nothing when quality doesn't change..
                                    ...
                                    if (SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)
                                        ...
                                        SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)
                                            ?.setQualityWifi(ReuseFunctions.networkQualityWifi(this@VideoPreviewTutorialActivity))
                                        setUrlOfQuality(ReuseFunctions.networkQualityWifi(this@VideoPreviewTutorialActivity))
                                    }
                                }
                            }
                        }
    ...
    private fun setUrlBasedOnQuality(url: String) {
        runOnUiThread {
            if (SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)?.getPos() == "") {
                //do nothing
            } else {
                setplayer(url)
                val roundedBalance =
                    SharedPreferenceClass.getInstance(this@VideoPreviewTutorialActivity)?.getPos()
    ...
    private fun setTitleText(selectedModel: TutorialData) {
    ...
    private fun shareSheet() {
        ...
        val shareBody = URLDecoder.decode((selectedModel as TutorialData?)!!.shareablURL)
    ...
    private fun openDownloadBottomSheet() {
        if (selectedModel != null) {
            ...
            try {
                Glide.with(context)
                    .load(URLDecoder.decode((selectedModel as TutorialData?)!!.poster))
            ...
            dialogView.radiogroup.setOnCheckedChangeListener { arg0, arg1 ->
                ...
                try {
                    if (selectedId == R.id.radio_btn_high) {
                        ...
                        if ((selectedModel as TutorialData?)?.p720p?.url != null)
                            selected_url = (selectedModel as TutorialData?)!!.p720p!!.url
                    }
                    if (selectedId == R.id.radio_btn_medium) {
                        if ((selectedModel as TutorialData?)?.p480p?.url != null)
                            selected_url =
                                (selectedModel as TutorialData?)!!.p480p.url
                    }
                    if (selectedId == R.id.radio_btn_low) {
                        if ((selectedModel as TutorialData?)?.p240p?.url != null)
                            selected_url =
                                (selectedModel as TutorialData?)!!.p240p.url
                    }
                } catch (e: Exception) {
                    e.printStackTrace()
                }
    ...
    override fun onResume() {
        ...
        if ((selectedModel as TutorialData?) != null && (selectedModel as TutorialData?)?.p720p?.url != null) {
            val videoUrl: String = URLDecoder.decode((selectedModel as TutorialData?)!!.p720p!!.url)
            setplayer(videoUrl)
            videoview.start()
        }
        videoview.visibility = View.VISIBLE
            ...
            if (selectedId == -1) {
                ...
                if ((selectedModel as TutorialData?) != null)
                    try {
                        ...
                        var filename = (selectedModel as TutorialData?)!!.title
    ...
    override fun onQualityChangeSelected(qualityId: String) {
        ...
        when (qualityId) {
            "0" -> {
                if ((selectedModel as TutorialData?) != null && (selectedModel as TutorialData?)?.p240p?.url != null) {
                    try {
                        setVideoQuality(URLDecoder.decode((selectedModel as TutorialData?)!!.p240p.url))
                    } catch (e: UnsupportedEncodingException) {
                        e.printStackTrace()
                    }
                }
            ...
            "1" -> {
                if ((selectedModel as TutorialData?) != null && (selectedModel as TutorialData?)?.p360p?.url != null) {
                    try {
                        setVideoQuality(URLDecoder.decode((selectedModel as TutorialData?)!!.p360p.url))
                    } catch (e: UnsupportedEncodingException) {
                        e.printStackTrace()
                    }
                }
            ...
            "2" -> {
                if ((selectedModel as TutorialData?) != null && (selectedModel as TutorialData?)?.p480p?.url != null) {
                    try {
                        setVideoQuality(URLDecoder.decode((selectedModel as TutorialData?)!!.p480p.url))
                    } catch (e: UnsupportedEncodingException) {
                        e.printStackTrace()
                    }
                }
            ...
            "3" -> {
                if ((selectedModel as TutorialData?) != null && (selectedModel as TutorialData?)?.p720p?.url != null) {
                    try {
                        setVideoQuality(URLDecoder.decode((selectedModel as TutorialData?)!!.p720p!!.url))
                    } catch (e: UnsupportedEncodingException) {
                        e.printStackTrace()
                    }
                }
    ...
    override fun onVideoSelect(selectedModelVideo: TutorialData) {
        selectedModel = selectedModelVideo
        if (selectedModel != null && (selectedModel as TutorialData?)?.p720p?.url != null) {
            try {
                var TutorialDataTemp: TutorialData? =  null
                TutorialDataTemp= selectedModel as TutorialData
                var newIndex = list!!.indexOf(TutorialDataTemp)
                val videoUrl: String =
                    URLDecoder.decode((selectedModel as TutorialData?)!!.p720p!!.url)
                setNormalVideoViews()
                setplayer(videoUrl)
    ...
    private fun setNextPreVideo(value: Int) {
        if (selectedModel != null && (selectedModel as TutorialData?)?.indexPosition != null) {
            try {
    ...
    public class DownloadProgressCounter(
        ...
        var context: Context = VideoPreviewTutorialActivity()
        override fun run() {
            while (downloadId > 0) {
                try {
