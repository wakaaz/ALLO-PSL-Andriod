...
class VideoPreviewLearningTutorialAdapter(var context: Context, var type: String, var name: String, var onVideoSelectedListener: OnVideoSelectedListener) :
    RecyclerView.Adapter<VideoPreviewLearningTutorialAdapter.ViewHolder>() {
    private var diclist = emptyList<LearningData>()
    ...
    override fun onBindViewHolder(holder: VideoPreviewLearningTutorialAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            ...
            view.setOnClickListener(View.OnClickListener {
                onVideoSelectedListener.onVideoSelect(LearningData)
             })
        }
    }

    internal fun setWords(users: List<LearningData>) {
        this.diclist = users
