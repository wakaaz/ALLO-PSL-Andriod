...
class VideoPreviewTutorialAdapter(var context: Context, var type: String, var name: String, var onVideoSelectedListener: OnVideoSelectedListener) :
    RecyclerView.Adapter<VideoPreviewTutorialAdapter.ViewHolder>() {
    private var diclist = emptyList<TutorialData>()
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            ...
            view.setOnClickListener(View.OnClickListener {
                onVideoSelectedListener.onVideoSelect(TutorialData)
             })
        }
    }

    internal fun setWords(users: List<TutorialData>) {
        this.diclist = users
