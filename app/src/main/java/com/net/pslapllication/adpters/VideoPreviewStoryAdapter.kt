...
class VideoPreviewStoryAdapter(var context: Context, var type: String, var name: String, var onVideoSelectedListener: OnVideoSelectedListener) :
    ...
    override fun onBindViewHolder(holder: VideoPreviewStoryAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            ...
            view.setOnClickListener(View.OnClickListener {
                onVideoSelectedListener.onVideoSelect(StoryData)
             })
        }
    }

    internal fun setWords(users: List<StoryData>) {
        this.diclist = users
