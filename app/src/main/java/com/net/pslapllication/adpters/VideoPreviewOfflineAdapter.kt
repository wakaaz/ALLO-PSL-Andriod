...
class VideoPreviewOfflineAdapter(var context: Context, var type: String, var name: String, var onVideoSelectedListener: OnVideoSelectedListener) :
    RecyclerView.Adapter<VideoPreviewOfflineAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: VideoPreviewOfflineAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            DictionaryDataAPI: DictionaryDataAPI,
            type: String,
            name: String,
            onVideoSelectedListener: OnVideoSelectedListener
        ) {
            view.setOnClickListener(View.OnClickListener {
                onVideoSelectedListener.onVideoSelect(DictionaryDataAPI)
             })
        }
    }
